...
function clearList (id:string ){
    let lis = document.getElementById(id) as HTMLElement ;
...
function clearTableId(id: string) {
...
function addToList( tab: string , id, name ,h, w, d,  ) {
    let t = document.getElementById(tab) as HTMLTableElement;
